...
public:
	...
	CPageItem* AddPage(CRuntimeClass* pClass,UINT nIDTemplate,LPCTSTR sText,UINT IconID = NULL);
	CPageItem* AddPage(CRuntimeClass* pClass,UINT nIDTemplate,LPCTSTR sText,HICON hIcon);
	CPageItem* AddPage(CWnd *pWnd,LPCTSTR sText,UINT IconID = NULL);
	CPageItem* AddPage(CWnd *pWnd,LPCTSTR sText,HICON hIcon);
	void AutoSize();
