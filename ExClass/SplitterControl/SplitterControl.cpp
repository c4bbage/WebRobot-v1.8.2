                              ...
                              DWORD dwSplitterControlStyle, COLORREF clrSplitterColor, LONG lSplitterLineWidth)
{
    ...
    //  load the cursor
    //m_hCursor = ::LoadCursor(NULL, m_dwSplitterStyle&SPS_VERTICAL?IDC_SIZENWSE:IDC_SIZENESW);
	m_hCursor = AfxGetApp()->LoadCursor(m_dwSplitterStyle&SPS_VERTICAL?IDC_MYSIZEWE:IDC_MYSIZENS);
