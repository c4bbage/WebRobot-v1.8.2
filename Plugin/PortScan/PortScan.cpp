...
TCHAR *pName			= _T("端口扫描");
TCHAR *pDescription		= _T("端口扫描");
TCHAR *pAbout		= _T("<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=\"green\">端口扫描</font><br><br><br>&nbsp;&nbsp;&nbsp;\
					智能设置线程创建后的休息时间，避免漏扫。<br><br>&nbsp;&nbsp;&nbsp;\
					扫描方式可以是单独IP、IP列表、IP段(支持多段扫描)。<br><br>&nbsp;&nbsp;&nbsp;\
					端口可以为常用端口和指定范围的端口。<br><br>&nbsp;&nbsp;&nbsp;");
